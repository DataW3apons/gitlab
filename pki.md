![N|img](https://raw.githubusercontent.com/DataW3apons/gitlab/master/theguild.png)
----
# Principles, Patterns and Practices    
  [![N|Website](https://img.shields.io/badge/Pattern%20-Enterprise%20Certificate%20Authority-blue.svg?style=plastic)](https://cabforum.org/ca-practices/) 
  [![N|Website](https://img.shields.io/badge/Pattern%20-Integrated%20Identity%20Provider-blue.svg?style=plastic)](https://en.wikipedia.org/wiki/Identity_provider) 
  [![N|Website](https://img.shields.io/badge/Practice%20-Information%20Lifecycle%20Management%20%20-green.svg?style=plastic)](https://en.wikipedia.org/wiki/Information_lifecycle_management) 
...
$pkirealm   = "SKUNKWORKS"
$pkidomain  = "skunkworks.dataweapons.org"
$pkiou      = "OU=dataweaponsPKI"
$opsou      = "OU=Operations"

$basedn     = "DC=skunkworks, DC=dataweapons, DC=org"
$pkidn      = "${pkiou}, ${basedn}"
$opsdn      = "${opsou}, ${basedn}"
$pkigroupou = "OU=Groups,OU=Identities,${pkidn}"

$adms = "SKUNKWORKS CA Administrators"
$mgrs = "SKUNKWORKS CA Managers"
$ops  = "SKUNKWORKS CA Operators"
$aud  = "SKUNKWORKS CA Auditors"

$cAAdmins    = "CN=${adms}, ${pkigroupou}"
$cAMgrs      = "CN=${mgrs}, ${pkigroupou}"
$cAOperators = "CN=${ops}, ${pkigroupou}"
$cAAuditors  = "CN=${aud}, ${pkigroupou}"

## create and store credentials of admin user ##
$pkiadmuser  = "${pkirealm}\pkiadm"
$pkiadmpass  = ConvertTo-SecureString -String "<PASSWORD>" -AsPlainText -Force
$pkiadmcreds = New-Object -TypeName "System.Management.Automation.PSCredential" `
				-ArgumentList $pkiadmuser, $pkiadmpass

## load up our posh ##
Add-WindowsFeature RSAT-AD-PowerShell
Import-Module servermanager, activedirectory
Import-Module pspki
...
#>
New-ADOrganizationalUnit -Name "dataWeaponsPKI" `
    -path "${pkidn}" `
    -Credential $pkiadmcreds `
    -Country US `
    -Description "Enterprise PKI and PKCS for dataweapons.org Users" `
    -DisplayName "DATAWEAPONS PKI" `
    -ManagedBy "${cAMgrs}" `
